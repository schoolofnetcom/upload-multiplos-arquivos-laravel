        ...
        <div class="container">
            ...
            <form action="{{ route('gallery-upload') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="exampleFormControlInput1">Digite o nome da galeria</label>
                    <input type="text" name="title" class="form-control" id="exampleFormControlInput1" placeholder="Aniversário xxxx">
                </div>
                <div class="form-group">
